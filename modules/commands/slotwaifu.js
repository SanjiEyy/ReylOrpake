module.exports.config = {
    ...
    usages: "<[Zeeshan/Nami/Chitanda/Mirai/Elaina/Mikasa] or [🔥/⚡/��/🦞/🦵/🐱]> <Bet amount (note must be over 50$)>",
    cooldowns: 0
  };
  ...
  module.exports.run = async function({ api, event, args, Currencies, getText, permssion }) {
    try {
      ...
      const slotItems = ["Zeeshan", "Nami", "Chitanda", "Mirai", "Elaina", "Mikasa"];
      ...
      if (content == 'Zeeshan' || content == '🔥') {
        ...
        return api.sendMessage(`Wrong format\n${global.config.PREFIX}${this.config.name} [Zeeshan/Nami/Chitanda/Mirai/Elaina/Mikasa] hoặc[🔥/⚡/🍙/🦞/🦵/🐱] <Số tiền cược(lưu ý phải trên 50$)>`, threadID, messageID);
      }
      // request
