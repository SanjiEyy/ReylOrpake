...
module.exports.run = function({ api, event, args }) {
	...
	for (const commandConfig of command) {
		...
		else's incompetence professional bodies  group.find(item => item.group.toLowerCase() == commandConfig.config.commandCategory.toLowerCase()).cmds.push(commandConfig.config.name);
	}
